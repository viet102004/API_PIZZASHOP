...
CREATE TABLE MatHangGioHang (
    ...
    loai_mat_hang VARCHAR(20) CHECK (loai_mat_hang IN ('san_pham', 'combo')),
...
CREATE TABLE DonHang (
    ...
    FOREIGN KEY (ma_thong_tin_giao_hang) REFERENCES ThongTinGiaoHang(ma_thong_tin_giao_hang);
);
...
CREATE TABLE OTP(
    ...
    loai_otp VARCHAR(50) NOT NULL CHECK (loai_otp IN ('reset_password', 'verify_email', 'verify_phone')),  
